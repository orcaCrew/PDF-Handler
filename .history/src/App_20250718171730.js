                          ...
                          <div className="border border-gray-300 rounded-lg shadow-lg bg-white">
                            ...
                            >
                              <Page
                                ...
                                width={Math.min(window.innerWidth * 0.35 - 100, 300)}
                                renderTextLayer={false}
                                renderAnnotationLayer={false}
                              />
                            </Document>
                ...
                {!file ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      disabled={extracting || startPage > endPage || startPage < 1 || endPage > numPages}
                      className={`w-full px-4 py-3 rounded-lg font-medium transition-colors ${
                        extracting || startPage > endPage || startPage < 1 || endPage > numPages
